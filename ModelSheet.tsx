...
import { Award, CircleCheck as CheckCircle2, ImageOff, MessageCircleQuestionMark as MessageCircleQuestion, Shirt, Sparkles, TrendingUp } from "lucide-react";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
          ...
          <div className="relative">
            {hero ? (
              <img
                src={hero}
                alt={model.name}
                className="max-h-[60vh] w-full bg-secondary object-contain"
              />
            ) : (
